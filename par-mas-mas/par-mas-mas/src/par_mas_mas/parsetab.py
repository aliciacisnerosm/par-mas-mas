...
_lr_productions = [
  ...
  ('program -> PROGRAM ID COLON main','program',4,'p_program','lexer.py',93),
  ('program -> PROGRAM ID COLON variables main','program',5,'p_program','lexer.py',94),
  ('program -> PROGRAM ID COLON variables funciones main','program',6,'p_program','lexer.py',95),
  ('program -> PROGRAM ID COLON funciones main','program',5,'p_program','lexer.py',96),
  ('main -> MAIN LEFT_PAR RIGHT_PAR LEFT_CURL main_aux RIGHT_CURL','main',6,'p_main','lexer.py',102),
  ('main_aux -> estatutos_main_multiple','main_aux',1,'p_main_aux','lexer.py',108),
  ('main_aux -> empty','main_aux',1,'p_main_aux','lexer.py',109),
  ('variables -> VAR SEMICOLON','variables',2,'p_variables','lexer.py',114),
  ('variables -> VAR variables_aux SEMICOLON','variables',3,'p_variables','lexer.py',115),
  ('variables_aux -> tipo COLON dec_var','variables_aux',3,'p_variables_aux','lexer.py',120),
  ('variables_aux -> tipo COLON dec_var MORE variables_aux','variables_aux',5,'p_variables_aux','lexer.py',121),
  ('tipo -> INT','tipo',1,'p_tipo','lexer.py',126),
  ('tipo -> FLOAT','tipo',1,'p_tipo','lexer.py',127),
  ('tipo -> CHAR','tipo',1,'p_tipo','lexer.py',128),
  ('dec_var -> dec_varaux COMMA dec_var','dec_var',3,'p_dec_var','lexer.py',133),
  ('dec_var -> dec_varaux','dec_var',1,'p_dec_var','lexer.py',134),
  ('dec_varaux -> ID','dec_varaux',1,'p_dec_varaux','lexer.py',139),
  ('dec_varaux -> ID LEFT_BR CTE_I RIGHT_BR','dec_varaux',4,'p_dec_varaux','lexer.py',140),
  ('dec_varaux -> ID LEFT_BR CTE_I RIGHT_BR LEFT_BR CTE_I RIGHT_BR','dec_varaux',7,'p_dec_varaux','lexer.py',141),
  ('funciones -> funciones_aux','funciones',1,'p_funciones','lexer.py',146),
  ('funciones -> funciones_aux funciones','funciones',2,'p_funciones','lexer.py',147),
  ('funciones_aux -> tipo FUNC ID LEFT_PAR parametros RIGHT_PAR LEFT_CURL variables estatutos RIGHT_CURL','funciones_aux',10,'p_funciones_aux','lexer.py',153),
  ('funciones_aux -> tipo FUNC ID LEFT_PAR RIGHT_PAR LEFT_CURL variables estatutos RIGHT_CURL','funciones_aux',9,'p_funciones_aux','lexer.py',154),
  ('funciones_aux -> VOID FUNC ID LEFT_PAR RIGHT_PAR LEFT_CURL variables estatutos RIGHT_CURL','funciones_aux',9,'p_funciones_aux','lexer.py',155),
  ('funciones_aux -> VOID FUNC ID LEFT_PAR parametros RIGHT_PAR LEFT_CURL variables estatutos RIGHT_CURL','funciones_aux',10,'p_funciones_aux','lexer.py',156),
  ('parametros -> dec_var_param COMMA parametros','parametros',3,'p_parametros','lexer.py',161),
  ('parametros -> dec_var_param','parametros',1,'p_parametros','lexer.py',162),
  ('dec_var_param -> tipo ID','dec_var_param',2,'p_dec_var_param','lexer.py',168),
  ('expresion -> exp','expresion',1,'p_expresion','lexer.py',174),
  ('expresion -> exp relacionales expresion','expresion',3,'p_expresion','lexer.py',175),
  ('expresion -> exp logicos expresion','expresion',3,'p_expresion','lexer.py',176),
  ('expresion -> LEFT_PAR expresion RIGHT_PAR','expresion',3,'p_expresion','lexer.py',177),
  ('expresion -> LEFT_PAR expresion RIGHT_PAR relacionales expresion','expresion',5,'p_expresion','lexer.py',178),
  ('expresion -> LEFT_PAR expresion RIGHT_PAR logicos expresion','expresion',5,'p_expresion','lexer.py',179),
  ('logicos -> AND','logicos',1,'p_logicos','lexer.py',185),
  ('logicos -> OR','logicos',1,'p_logicos','lexer.py',186),
  ('relacionales -> LESS_THAN','relacionales',1,'p_relacionales','lexer.py',192),
  ('relacionales -> GREATER_THAN','relacionales',1,'p_relacionales','lexer.py',193),
  ('relacionales -> DIFFERENT','relacionales',1,'p_relacionales','lexer.py',194),
  ('relacionales -> EQUAL','relacionales',1,'p_relacionales','lexer.py',195),
  ('estatutos -> estatutos_main_aux','estatutos',1,'p_estatutos','lexer.py',200),
  ('estatutos -> retorno SEMICOLON','estatutos',2,'p_estatutos','lexer.py',201),
  ('estatutos_main -> asignacion SEMICOLON','estatutos_main',2,'p_estatutos_main','lexer.py',207),
  ('estatutos_main -> llamada SEMICOLON','estatutos_main',2,'p_estatutos_main','lexer.py',208),
  ('estatutos_main -> lectura SEMICOLON','estatutos_main',2,'p_estatutos_main','lexer.py',209),
  ('estatutos_main -> escritura SEMICOLON','estatutos_main',2,'p_estatutos_main','lexer.py',210),
  ('estatutos_main -> decision SEMICOLON','estatutos_main',2,'p_estatutos_main','lexer.py',211),
  ('estatutos_main -> repeticion SEMICOLON','estatutos_main',2,'p_estatutos_main','lexer.py',212),
  ('estatutos_main_multiple -> estatutos_main estatutos_main_multiple','estatutos_main_multiple',2,'p_estatutos_main_multiple','lexer.py',217),
  ('estatutos_main_multiple -> estatutos_main','estatutos_main_multiple',1,'p_estatutos_main_multiple','lexer.py',218),
  ('estatutos_main_aux -> estatutos_main estatutos','estatutos_main_aux',2,'p_estatutos_main_aux','lexer.py',223),
  ('estatutos_main_aux -> estatutos_main','estatutos_main_aux',1,'p_estatutos_main_aux','lexer.py',224),
  ('asignacion -> dec_varaux EQUALS exp','asignacion',3,'p_asignacion','lexer.py',230),
  ('exp -> termino exp_aux','exp',2,'p_exp','lexer.py',236),
  ('exp -> termino','exp',1,'p_exp','lexer.py',237),
  ('exp_aux -> PLUS exp','exp_aux',2,'p_exp_aux','lexer.py',242),
  ('exp_aux -> MINUS exp','exp_aux',2,'p_exp_aux','lexer.py',243),
  ('termino -> factor','termino',1,'p_termino','lexer.py',248),
  ('termino -> factor termino_aux','termino',2,'p_termino','lexer.py',249),
  ('termino_aux -> MULTIPLY termino','termino_aux',2,'p_termino_aux','lexer.py',254),
  ('termino_aux -> DIVIDE termino','termino_aux',2,'p_termino_aux','lexer.py',255),
  ('factor -> cte','factor',1,'p_factor','lexer.py',260),
  ('factor -> LEFT_PAR exp RIGHT_PAR','factor',3,'p_factor','lexer.py',261),
  ('factor -> ID LEFT_PAR dec_var RIGHT_PAR','factor',4,'p_factor','lexer.py',262),
  ('factor -> ID LEFT_PAR RIGHT_PAR','factor',3,'p_factor','lexer.py',263),
  ('llamada -> VD ID LEFT_PAR RIGHT_PAR','llamada',4,'p_llamada','lexer.py',268),
  ('llamada -> VD ID LEFT_PAR dec_var RIGHT_PAR','llamada',5,'p_llamada','lexer.py',269),
  ('retorno -> RETURN LEFT_PAR exp RIGHT_PAR','retorno',4,'p_retorno','lexer.py',274),
  ('lectura -> READ LEFT_PAR dec_var RIGHT_PAR','lectura',4,'p_lectura','lexer.py',279),
  ('escritura -> WRITE LEFT_PAR escritura_aux RIGHT_PAR','escritura',4,'p_escritura','lexer.py',284),
  ('escritura_aux -> STR','escritura_aux',1,'p_escritura_aux','lexer.py',289),
  ('escritura_aux -> exp','escritura_aux',1,'p_escritura_aux','lexer.py',290),
  ('escritura_aux -> STR COMMA escritura_aux','escritura_aux',3,'p_escritura_aux','lexer.py',291),
  ('escritura_aux -> exp COMMA escritura_aux','escritura_aux',3,'p_escritura_aux','lexer.py',292),
  ('decision -> IF LEFT_PAR expresion RIGHT_PAR THEN LEFT_CURL estatutos RIGHT_CURL','decision',8,'p_decision','lexer.py',297),
  ('decision -> IF LEFT_PAR expresion RIGHT_PAR THEN LEFT_CURL estatutos RIGHT_CURL ELSE LEFT_CURL estatutos RIGHT_CURL','decision',12,'p_decision','lexer.py',298),
  ('repeticion -> condicional','repeticion',1,'p_repeticion','lexer.py',303),
  ('repeticion -> no_condicional','repeticion',1,'p_repeticion','lexer.py',304),
  ('no_condicional -> FOR LEFT_PAR dec_varaux EQUALS exp TO exp RIGHT_PAR DO LEFT_CURL estatutos RIGHT_CURL','no_condicional',12,'p_no_condicional','lexer.py',309),
  ('condicional -> WHILE LEFT_PAR expresion RIGHT_PAR DO LEFT_CURL estatutos RIGHT_CURL','condicional',8,'p_condicional','lexer.py',314),
  ('cte -> ID','cte',1,'p_cte','lexer.py',318),
  ('cte -> CTE_I','cte',1,'p_cte','lexer.py',319),
  ('cte -> CTE_F','cte',1,'p_cte','lexer.py',320),
